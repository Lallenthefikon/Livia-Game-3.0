...
class Terrain{
public:
	enum TERRAINTYPE { BLOCK0, BLOCK0WALLJUMP, SPIKES, BLOCKGOAL, COLLISIONBLOCK, DIALOGUE, MEATBALLSPAWNER };
	enum TERRAINTYPE { BLOCK0ICY, BLOCK0, BLOCK0WALLJUMP, SPIKES, BLOCKGOAL, COLLISIONBLOCK };
	Terrain();
	virtual ~Terrain();
