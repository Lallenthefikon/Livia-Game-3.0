...
struct Toolbox {
	...
	static enum TEXTUREKEY { WORMTEXTURE, BLOCK0TEXTURE, PLAYERTEXTURE, PLAYERIDLETEXTURE, TILETEXTURE, EDITORMENY, ACIDMONSTERTEXTURE };
	static enum SOUNDKEY { PLAYERIDLE, PLAYERRUN, PLAYERJUMP, PLAYERLAND, PLAYERDAMAGED, WORMIDLE, WORMRUN, WORMJUMP, WORMLAND };
