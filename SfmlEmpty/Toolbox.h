...
struct Toolbox {
	...
	enum TEXTUREKEY { WORMTEXTURE, BLOCK0TEXTURE, RUNNINGPLAYERTEXTURE, PLAYERJUMPTEXTURE, PLAYERIDLETEXTURE, PLAYERHURTTEXTURE, PLAYERSLIDETEXTURE, TILETEXTURE, EDITORMENY, ACIDMONSTERTEXTURE, STOMACHBACKGROUND, LIFETEXTURE};
