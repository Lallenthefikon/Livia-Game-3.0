...
struct Toolbox {
	...
	enum TEXTUREKEY { WORMTEXTURE, BLOCK0TEXTURE, RUNNINGPLAYERTEXTURE, PLAYERJUMPTEXTURE, PLAYERIDLETEXTURE, PLAYERHURTTEXTURE, PLAYERSLIDETEXTURE, TILETEXTURE, EDITORMENY, ACIDMONSTERTEXTURE, STOMACHBACKGROUND, LIFETEXTURE, GOALTEXTURE };
	enum SOUNDKEY { PLAYERIDLE, PLAYERRUN, PLAYERJUMP, PLAYERLAND, PLAYERDAMAGED, PLAYERDEATH, PLAYERWALLSLIDE, WORMIDLE, WORMRUN, WORMJUMP, WORMLAND, WORMDEATH, STOMACHMUSIC, STOMACHAMBIENCE };
